...
model = DQN.load("models/dqn/DQN_run_real/dqn_pricing_model")
...
df.to_csv("data/generated/eval_output_dqn_real.csv", index=False)
print("✅ Evaluation saved to data/generated/eval_output_dqn_real.csv")
...
plt.tight_layout()
plt.savefig("analysis/real/plot_dqn_demand_vs_price.png")
plt.close()
...
plt.ylabel("Reward")
plt.tight_layout()
plt.savefig("analysis/real/plot_dqn_reward_over_time.png")
plt.close()
