...
plt.ylabel("Reward (€)")
plt.tight_layout()
plt.savefig("analysis/real/dqn_reaward_over_time.png")
plt.close()
...
plt.tight_layout()
plt.savefig("analysis/real/dqn_price_over_time.png")
plt.close()
...
plt.ylabel("Profit (€)")
plt.tight_layout()
plt.savefig("analysis/real/dqn_profit_vs_price.png")
plt.close()
...
plt.tight_layout()
plt.savefig("analysis/real/dqn_demand_vs_price.png")
plt.close()
...
plt.tight_layout()
plt.savefig("analysis/real/dqn_price_change_distribution.png")
plt.close()
...
plt.tight_layout()
plt.savefig("analysis/real/demand_vs_action_type.png")
plt.close()
...
plt.ylabel("% veiksmų")
plt.tight_layout()
plt.savefig("analysis/real/price_change_by_category.png")
plt.close()
...
plt.tight_layout()
plt.savefig("analysis/real/elasticity_vs_action.png")
plt.close()
...
pd.DataFrame([summary]).to_csv("data/generated/analysis/dqn_summary_metrics_real.csv", index=False)
...
plt.tight_layout()
plt.savefig("analysis/real/price_violation_count.png")
plt.close()
...
plt.xticks([0, 1], ['Ne', 'Taip'])
plt.tight_layout()
plt.savefig("analysis/real/over_demand_cases.png")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig("analysis/real/rolling_reward_price.png")
plt.close()
...
plt.tight_layout()
plt.savefig("analysis/real/category_elasticity.png")
plt.close()
...
plt.tight_layout()
plt.savefig("analysis/real/price_change_action_distribution.png")
plt.close()
...
plt.tight_layout()
plt.savefig("analysis/real/weekly_price_demand_sold.png")
plt.close()
...
# === FULL CURVE ===
# === 1. Load monitor log ===
log_path = "logs/dqn/monitor_real.csv.monitor.csv"  # kelias gali skirtis pagal tavo projektą
...
plt.grid(True)
plt.tight_layout()
plt.savefig("analysis/real/full_dqn_training_reward.png")
plt.close()
