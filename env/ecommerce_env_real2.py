...
class AdvancedPricingEnv(gym.Env):
    def __init__(self, data_path='data/generated/weekly_env_data_augmented.csv', episode_length=52, verbose=False):
        ...
        #self.data["main_category"] = self.data["main_category"].fillna("other")

        self.encoder = OneHotEncoder(sparse_output=False, handle_unknown="ignore")
        #self.encoded_categories = self.encoder.fit_transform(self.data[["translated_name", "main_category"]])
    ...
    def step(self, action):
        ...
        info = {
            ...
            #"main_category": row.get("main_category", "other"),
